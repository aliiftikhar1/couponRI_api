...
export default function Subscribe() {
  return (
    <div className="bg-blue-600 h-[300px] text-white py-12 px-6 rounded-lg flex flex-col justify-center items-center">
      <h2 className="text-5xl w-[1000px] font-bold mb-4 text-center">
