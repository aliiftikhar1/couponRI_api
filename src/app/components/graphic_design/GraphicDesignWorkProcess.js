...
import { LightBulbIcon, PencilIcon, AdjustmentsVerticalIcon, ClipboardIcon } from '@heroicons/react/24/outline';

export default function GraphicDesignWorkProcess() {
  const steps = [
    {
      number: "1",
  ...
  return (
    <section className="py-12 bg-yellow-100">
      <div className="container mx-auto px-6">
        <h2 className="text-center text-3xl font-bold text-gray-900 mb-8">Over Graphic Design Service Work Process</h2>
